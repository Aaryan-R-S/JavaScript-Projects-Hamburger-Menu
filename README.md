...
<p align="center">
  ...
  <h3 align="center">Hambuger Menu</h3>
...
This is a Hambuger Menu developed using JavaScript. It can collapse and expand when required which is helpful in making responsive web pages!
<br>
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/JavaScript-Projects-Hamburger-Menu.git
   ```
